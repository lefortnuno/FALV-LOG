                ...
                <div className="modal-content">
                    ...
                    <div className="modal-body">
                        <form>
                            ...
                            <div className="form-group">
                                <label for="recipient-name" className="col-form-label">Coordonnées du Magasin:</label>
                                <input
                                    type="text"
                            ...
                            <div className="form-group">
                                <label for="message-text" className="col-form-label">Raison de la fidélisation:</label>
